...
rec {
  ...
  preHook = ''
    ...
    export NIX_CFLAGS_COMPILE+=" --sysroot=/var/empty -idirafter $SDKROOT_X/usr/include -idirafter $SDKROOT_X/usr/include/c++/v1 -F$SDKROOT_X/System/Library/Frameworks -Wno-multichar -Wno-deprecated-declarations"
